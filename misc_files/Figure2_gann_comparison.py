...
def generate_plot(df, low_points, title, filename, x_lim, y_lim=None):
    ...
    for label, low_date in low_points.items():
        ...
        lines_to_plot = {
            ...
            'Gann Equilibrium (1:1)': {'slope': 1.0, 'color': 'red', 'linestyle': '-', 'alpha': 1.0, 'linewidth': 1.5},
            'Gann (1:2)': {'slope': 0.5, 'color': 'red', 'linestyle': '--', 'alpha': 1.0, 'linewidth': 1.5},  # More faded
            
            # Plastic Lines
            'Plastic Equilibrium (1:1)': {'slope': 1.3247, 'color': 'blue', 'linestyle': '-', 'alpha': 1.0, 'linewidth': 1.5},
...
generate_plot(
    ...
    title='Gann and Plastic Lines From 2009 Low For S&P 500',
    filename='Figure2_gann_plastic_lines.png',
