...
DATA_FILE_PATH = os.path.join('historical_data', 'DX-Y.NYB.csv')
...
def create_model_and_plot(data_path, lag1, lag2):
    ...
    plt.title(f'Illustration: US Dollar Index Price Series and Fitted Plastic Model\n', 
    ...
    # Save the plot
    plt.savefig('Figure3_usdollar_model.png')
